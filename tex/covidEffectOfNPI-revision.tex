...
{\ycolor Y_{i,t - \ell m}} \Big )  \end{equation}
 ...
 and $t/\ell$ is defined as $\lceil {t/\ell} \rceil$.
...
\begin{array}{lll}
 ...
 \end{array}
 $$
 interpreting $t/\ell$ as $\lceil t/\ell \rceil$, where $\mathrm{PEB}^\star_{i,t } =  \mathrm{PED}^\star_{i,t} = 0$
 for $t \leq 0$.  The effects can be decomposed into (a) delayed policy effects via behavior by
