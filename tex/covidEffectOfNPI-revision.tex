...
reduce to $$  {\bcolor \alpha '}  {\pcolor  \beta' }+{\pcolor \pi'} \text{ and } {\bcolor  \alpha '}  {\icolor  \gamma'} + {\icolor  \mu'},$$ respectively. This construction is not as efficient as generalized method of moments,
...
effect of policies on case and death growth. The upper two panels of figure \ref{fig:masks}
show average case and death growth conditional on date and whether
masks are mandatory for employees.\footnote{We take 14 and 21 day lags of mask policies for case and death growths, respectively, to  identify the states with a mask mandate because policies affect cases and deaths with time lags. See our discussion in the Appendix \ref{sec:timing}.} The upper left panel of the figure shows that states with a mask mandate consistently have 0-0.2 lower case
growth than states without. The upper right panel also illustrates that
states with a mask mandate tend to have lower average death growth than states without a mask mandate. The lower two panels of figure \ref{fig:masks} are similar to the upper two panels except that we use the residuals of  regressing case or death growth on state-level characteristics, month dummies, and their interactions in place of  case or death growth, indicating that states with a mask mandate tend to have lower case and death growths even after controlling for confounders. 
