...
\begin{abstract}
The paper evaluates the dynamic impact of various policies adopted by US states on the growth rates of confirmed Covid-19  cases and deaths as well as social distancing behavior measured by Google Mobility Reports, where we take into consideration people's voluntarily behavioral response to new information of transmission risks in a causal structural model framework. Our analysis finds that both policies and information on transmission risks are important determinants of Covid-19  cases and deaths and shows that a change in policies explains a large fraction of observed changes in social distancing behavior. Our main Lcounterfactual experiments suggest that nationally mandating face masks for employees on April 1st could have reduced the growth rate of cases and deaths  by more than 10 percentage points in late April, and could have led to as much as 17 to 55 percent less deaths nationally by the end of May, which roughly translates into 17 to 55 thousand saved lives.   We also find that, without stay-at-home orders, cases would have been larger by  25 to 170 percent, which implies that 0.5 to 3.4 million more Americans could have been infected if stay-at-home orders had not been implemented. We find considerable uncertainty over the effects of school closures due to lack of cross-sectional variation;  we could not robustly rule out either large or small effects.  We also carry out sensitivity analyses to find neighborhoods of
the models under which the results hold robustly.  Overall, substantial declines in growth rates are attributable to private behavioral response, but policies played an important role as well.   We stress that our study is observational and should be interpreted with great caution. From a completely agnostic point of view,
...
%     \multicolumn{2}{c}{\textbf{Cases}}     \multicolumn{2}{c}{\textbf{Deaths}}
 %  \\
     \includegraphics[width=0.49\textwidth]{tables_and_figures/us-mask-rel_v1}        \includegraphics[width=0.49\textwidth]{tables_and_figures/us-mask-rel_deaths_v1}
    \end{tabular}
  \end{minipage}
%    \begin{flushleft}
%      \footnotesize
...
In order to compute the counterfactual relative contrasts for levels variables, for example, confirmed cases $C_{it}$
...
\begin{equation}
C^{\star}_{it}/C_{it} =  \sum_{i=1}^N w_i \exp(  \sum_{\bar t=1}^t ( Y^\star_{i\bar t} -  Y_{i\bar t}) ), \quad w_i = C_{it}/\sum_{i=1}^N C_{it}.
\end{equation}
...
\input{tables_and_figures/policies_inregs}
  ...
  \begin{landscape}
    \begin{table}[!htbp] \centering
      ...
      \begin{minipage}{\linewidth}
        ...
        \resizebox{\textwidth}{!}{
          \footnotesize
          \input{tables_and_figures/behavior-NI-pib}
        }
      \begin{flushleft}
        \scriptsize
  ...
  \begin{table}[!htbp] \centering
    ...
    \begin{subtable}{\linewidth}\caption{Deaths as Information \label{tab:PItoBdeaths}}
      \begin{minipage}{\linewidth}
        ...
        \resizebox{\textwidth}{!}{
          \footnotesize
            \input{tables_and_figures/behavior-deathsinfo-NI-pib}
          }
        \begin{flushleft}
          \scriptsize
          Dependent variables are   ``Transit
...
\begin{table}[!htbp] \centering
 ...
 \begin{minipage}{\linewidth}
   ...
   \begin{minipage}{0.51\linewidth}
     \centering
     \input{tables_and_figures/cases-pbiy}
   \end{minipage}
     %\hspace{1pt}
     &
   \begin{minipage}{0.51\linewidth}
     \centering
     \input{tables_and_figures/deaths-deathsinfo-pbiy}
   \end{minipage}
   \end{tabular}
   }
 \begin{flushleft}
...
%     \begin{minipage}{\linewidth}
%       \centering
%       \input{tables_and_figures/cases-piy}
%     \end{minipage}
%     \end{tabular}
%     \begin{flushleft}
%       \scriptsize Dependent variable is the weekly growth rate of
...
%     \begin{minipage}{\linewidth}
%       \centering
%       \input{tables_and_figures/deaths-deathsinfo-piy}
%     \end{minipage}
...
\begin{table}[!htbp] \centering
 ...
 \begin{minipage}{\linewidth}
   ...
   \begin{flushleft}
     ...
     corresponding daily measures.  The row
     ``$\sum_j \mathrm{Policies}_j$'' reports the sum of all policy
     coefficients.   ``business closure policies'' is defined by the average of   closured movie theaters, closured restaurants, and closured non-essential businesses.  Standard errors are clustered at the state level.    \end{flushleft}
 \end{minipage}
\end{table}
\end{landscape}
}
...
\begin{minipage}{\linewidth}
  ...
  \begin{tabular}{c}
    \textbf{Cases}
    \\
    \input{tables_and_figures/dieff-cases-SI}
    \\
    \textbf{Deaths}
    \\
    \input{tables_and_figures/dieff-deaths-deathsinfo-SI}
  \end{tabular}
  \smallskip
  \begin{flushleft}
...
\begin{table}[!h]
  \caption{\label{tab:dieff-con-si}Direct and Indirect Policy Effects
    without national case/death variables, \textbf{constraints imposed}}
\begin{minipage}{\linewidth}
  \centering
    \scriptsize
  \begin{tabular}{c}
    \textbf{Cases}
    \\
    \input{tables_and_figures/dieff-cases-constrain-SI}
    \\
    \textbf{Deaths}
    \\
    \input{tables_and_figures/dieff-deaths-deathsinfo-constrain-SI}
  \end{tabular}
  \smallskip
  \begin{flushleft}
    {\tiny Direct effects capture the effect of policy on case
...
%    \textbf{Cases}
%    \\
%    \input{tables_and_figures/dieff-cases-NI}
%    \\ \\
%    \textbf{Deaths}
%    \\
%    \input{tables_and_figures/dieff-deaths-deathsinfo-NI}
%    \\
%  \end{tabular}
%  \smallskip
%  \begin{flushleft}
...
%\afterpage{
%\begin{table}
%  \caption{\label{tab:dieff}Direct and Indirect Policy Effects with national case/death variables, \textbf{Constraints imposed}}
%\begin{minipage}{\linewidth}
%  \centering
%    \scriptsize
%  \begin{tabular}{c}
%    \textbf{Cases}
%    \\
%    \input{tables_and_figures/dieff-cases-constrain-NI}
%    \\ \\
%    \textbf{Deaths}
%    \\
%    \input{tables_and_figures/dieff-deaths-deathsinfo-constrain-NI}
%    \\
%  \end{tabular}
%  \smallskip
%  \begin{flushleft}
...
In this section, we provide sensitivity analysis by estimating (\ref{eq:R4}) with alternative specifications and methods. Figure \ref{fig:whisker} shows  the 90\% confidence intervals of   coefficients of (A) masks for employees, (B)  closed K-12 school, (C) stay-at-home, and (D) the average variable of  closed movie theaters, closed restaurants, and closed non-essential businesses for the following specifications and estimation methods:
 ...
 %  \item[(10)]   Add latent state confounders and weekly dummies as components of $W_{it}$, estimated using fixed effects with bias correction.
...
Fixed Effects Specification: the Total Effect of Policies on Case and Death Growth ($PI \to Y$)}\vspace{-0.3cm}
 \begin{minipage}{\linewidth}
   ...
   \begin{minipage}{0.51\linewidth}
     \centering
     \input{tables_and_figures/cases-fe-piy}
   \end{minipage}
     &
   \begin{minipage}{0.51\linewidth}
     \centering
     \input{tables_and_figures/deaths-fe-piy}
   \end{minipage}
...
business policies only indirect effects.\footnote{Results (not shown)
  using the unconstrained estimates in Table \ref{tab:dieff-si} are similar.}
...
\begin{figure}[ht]
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{tabular}{cc}
      ...
      % &
        \includegraphics[width=0.49\textwidth]{tables_and_figures/Washington-mask-dgrowth_idx}
      &        \includegraphics[width=0.49\textwidth]{tables_and_figures/Washington-mask-dcases_idx}
      \\
      \\
      \multicolumn{2}{c}{\textbf{Deaths}}
      \\
      % \includegraphics[width=0.31\textwidth]{tables_and_figures/Washington-mask-growth_deaths} &
                                                                                                   \includegraphics[width=0.49\textwidth]{tables_and_figures/Washington-mask-dgrowth_deaths_idx}
      &      \includegraphics[width=0.49\textwidth]{tables_and_figures/Washington-mask-dcases_deaths_idx}
    \end{tabular}

    \begin{flushleft}
      \footnotesize
      The vertical (often truncated) text denotes the
      dates that Washington imposed each policy.  To compute the
      estimated and counterfactual paths we use the average of two
      estimated coefficients as reported in column ``Average'' of
      Table \ref{tab:dieff-con-si}. We set initial
      $\Delta \log \Delta C$ and $\log \Delta C$ to their values first
      observed in the state we are simulating. We hold all other
      regressors at their observed values. The shaded region is a
...
about 300 fewer cases and 10 fewer deaths in Washington in total by
the start of June.
...
\begin{figure}[ht]
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{tabular}{cc}
      \multicolumn{2}{c}{\textbf{Cases}} \\
      \includegraphics[width=0.49\textwidth]{tables_and_figures/us-mask-dgrowth_idx}
      &
        \includegraphics[width=0.49\textwidth]{tables_and_figures/us-mask-rel_idx}
      \\
      \\
      \multicolumn{2}{c}{\textbf{Deaths}} \\
      \includegraphics[width=0.49\textwidth]{tables_and_figures/us-mask-dgrowth_deaths_idx}
      &
        \includegraphics[width=0.49\textwidth]{tables_and_figures/us-mask-rel_deaths_idx}
    \end{tabular}
    ...
    \begin{flushleft}
      ...
      change in growth. The right column shows the change in cases or
...
could have led to 30\% fewer cumulative cases and 34\% fewer
cumulative deaths by the end of May with their 90 percent intervals given by $[13,46]$\% and $[12,47]$\%, respectively. The result roughly translates into $30$ thousand saved lives.
...
without business closures, cases and deaths would be about 60\% at the
end of May. The confidence intervals are wide. A 90 percent confidence
interval for the increase in cases at the end of May is 0 to
150\%. The confidence interval for deaths is even wider.
...
\begin{figure}[ht]
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{tabular}{cc}
      ...
      &
        \includegraphics[width=0.45\textwidth]{tables_and_figures/us-index-rel_idx}
      \\
      \\
      \multicolumn{2}{c}{\textbf{Deaths}} \\
      \includegraphics[width=0.45\textwidth]{tables_and_figures/us-index-dgrowth_deaths_idx}
      &
        \includegraphics[width=0.45\textwidth]{tables_and_figures/us-index-rel_deaths_idx}
    \end{tabular}
...
\begin{figure}[ht]
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{tabular}{cc}
      ...
      &
        \includegraphics[width=0.45\textwidth]{tables_and_figures/us-shelter-rel_idx}
      \\
      \\
      \multicolumn{2}{c}{\textbf{Deaths}} \\
      \includegraphics[width=0.45\textwidth]{tables_and_figures/us-shelter-dgrowth_deaths_idx}
      &
        \includegraphics[width=0.45\textwidth]{tables_and_figures/us-shelter-rel_deaths_idx}
    \end{tabular}
...
[Discussion on the effect of school closures has been moved to
sensitivity analysis section.]

[Do we even still need this section?]
...
\input{tables_and_figures/casecor.tex}

\input{tables_and_figures/casediff.tex}
...
\input{tables_and_figures/newcasecor.tex}
...
\input{tables_and_figures/weekcasecor}
...
\input{tables_and_figures/weekdeathcor}
...
\afterpage{%
  ...
  \begin{landscape}% Landscape page
    ...
    \input{tables_and_figures/policies}
  \end{landscape}
...
\afterpage{
\begin{table}
  \caption{\label{tab:dieff-con}Direct and Indirect Policy Effects with national case/death variables, \textbf{constraints imposed}}
\begin{minipage}{\linewidth}
  \centering
    \scriptsize
  \begin{tabular}{c}
...
\fixme
% DO WE STILL WANT THESE? THESE FIGURES HAVE NOT BEEN UPDATED.
