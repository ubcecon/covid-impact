...
%     \multicolumn{2}{c}{\textbf{Cases}}     \multicolumn{2}{c}{\textbf{Deaths}}
 %  \\
    ...
    \begin{flushleft}
      ...
      cases if all states had mandated masks on April 1st. The thick
      blue line is the estimated change in weekly cases or deaths
      relative to the observed number of weekly cases or deaths. The
      shaded region is a point wise 90\% confidence band.
    \end{flushleft}
  \end{minipage}
\end{figure}
...
%        \includegraphics[width=0.45\textwidth]{tables_and_figures/us-nb-rel_deaths}
    ...
    \begin{flushleft}
      \footnotesize This figure shows the estimated relative change in
      cases if no states had never implemented any business closure
      policies. The thick blue line is the estimated change in weekly
      cases or deaths relative to the observed number of weekly cases
...
\begin{figure}[ht]
 % \caption{National effect of leaving non-essential businesses open\label{fig:US-nb}}
  \caption{Effect  of  not implementing stay-at-home order on cases in the US  \label{fig:US-shelter-dgrowth_idx}}
  \begin{minipage}{\linewidth}
    \centering
    \begin{tabular}{cc}
  %    \includegraphics[width=0.45\textwidth]{tables_and_figures/us-shelter-dgrowth_v1}
    ...
    \begin{flushleft}
      \footnotesize This figure shows the estimated relative change in
      cases if no states had ever issued stay at home orders. The thick
      blue line is the estimated change in weekly cases or deaths
      relative to the observed number of weekly cases or deaths. The
      shaded region is a point wise 90\% confidence band.
    \end{flushleft}
...
case and death growth translate into changes in weekly cases and
deaths. The estimates imply that mandating masks on April 1st would
have led to about 150 fewer cases and 20 fewer deaths per week in
Washington by the start of June.
...
April 1st. The top panel shows the effect on cases and the bottom
...
\ref{fig:US-mask} shows the national relative change in weekly cases
or deaths. The point estimates indicate that mandating masks on April
1st could have led to 20\% fewer weekly cases and 35\% fewer
weekly deaths by the end of May with their 90 percent intervals
given by $[8,32]$\% and $[18,50]$\%, respectively.

%The result roughly
%translates into $30$ thousand saved lives.
...
without business closures, cases and deaths would be about 75\% higher
at the end of May. The confidence intervals are wide. A 90 percent
confidence interval for the increase in cases at the end of May is 25\%
to 140\%. The confidence interval for deaths is even wider, $[10, 250]$\%
...
translates to 60\% [10\%,140\%] more cases per week by the start of June. The
