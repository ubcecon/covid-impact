    ...
    \resizebox{\linewidth}{!}{
      \input{tables_and_figures/corr}
       ...
       \begin{flushleft}
         ...
         a pair of policy and behavior variables. ``ave of four policy vars'' is defined by the average of stay-at-home, closured movie theaters, closured restaurants, and closured non-essential businesses. 
       \end{flushleft}
  \end{minipage}
\end{table}
...
For this reason, we also consider a specification that includes
the average of stay-at-home, closured movie theaters, closed  restaurants, and closured non-essential businesses in place of these four policy variables separately.
...
\begin{table}[!htbp] \centering
 ...
 \begin{flushleft}
     ...
     1st-10th.   ``ave of four policy vars'' is defined by the average of stay-at-home orders, closured movie theaters, closured restaurants, and closured non-essential businesses.  Standard errors are clustered at the state level. 
   \end{flushleft}
 \end{minipage}
\end{table}
\end{landscape}
...
Column (1) represents our baseline specification while column (2) replaces stay-at-home, closed movie theaters, closed restaurants, and closed non-essential businesses with the average of these four policy variables. Columns (3) and (4) include past cases/deaths and growth rates at national level as additional regressors.
...
variables from April 1st-10th. The estimates of $-0.73$ and $-0.79$ for ``$\sum_k w_k \mathrm{Behavior}_k$'' in column (1)  imply that a reduction in mobility measures relative to the baseline in January and February have induced a decrease in case and death growth rates by 73 and 79 percent, respectively, suggesting an importance of social distancing for reducing the spread of Covid-19.
...
\begin{table}[!htbp] \centering
 ...
 \begin{minipage}{\linewidth}
   ...
   \begin{flushleft}
     ...
     corresponding daily measures.  The row
     ``$\sum_j \mathrm{Policies}_j$'' reports the sum of six policy
     coefficients.   ``ave of four policy vars'' is defined by the average of stay-at-home orders, closured movie theaters, closured restaurants, and closured non-essential businesses. Standard errors are clustered at the state level.
   \end{flushleft}
 \end{minipage}
\end{table}
\end{landscape}
...
0.75 and 1.01, respectively,   out of which more than one-half to
...
\(\Delta \log \Delta D\) by  0.97 and  0.48, respectively. For
...
appendix). Since then it has declined to near 0. Therefore,  -0.97 and -0.48 imply
...
Panel (C) of Figure  \ref{fig:whisker} indicates that the estimated coefficients of stay-at-home order  are generally negative and often significant 
 except for fixed effects estimator with bias correction. The sensitivity under fixed effects estimator may be due to high correlations between stay-at-home order  and closures of movie theaters, restaurants, and non-essential businesses. As shown in Panel (D), the  estimated coefficient of the average of  stay-at-home order  and closures of movie theaters, restaurants, and non-essential businesses   are  negative and often significant even under fixed effect specification; similar to school closure estimates, however,  its estimate is sensitive to controlling for national cases and deaths because the timing of implementing these policies is similar across states.
...
\begin{figure}[ht]
 ...
 $\quad$  (i) baseline timing$^\dagger$ &$\quad$ (ii) alternative timing$^\ddagger$\\ 
      ...
      &
      \includegraphics[width=0.5\textwidth]{tables_and_figures/pmaskbus-whisker-9} 
    \end{tabular}
 ...
 $\quad$  (i) baseline timing$^\dagger$ &$\quad$ (ii) alternative timing$^\ddagger$\\ 
      ...
      &
      \includegraphics[width=0.5\textwidth]{tables_and_figures/pk12-whisker-9}
          \end{tabular}
  \end{minipage}  
    \begin{flushleft}
      \footnotesize
...
\begin{figure}[ht]
 ...
 $\quad$  (i) baseline timing$^\dagger$ &$\quad$ (ii) alternative timing$^\ddagger$\\ 
      ...
      &
      \includegraphics[width=0.5\textwidth]{tables_and_figures/pshelter-whisker-9} 
    \end{tabular}
  \end{minipage} \\ \smallskip
    \begin{minipage}{\linewidth}
    \centering 
 ...
 $\quad$  (i) baseline timing$^\dagger$ &$\quad$ (ii) alternative timing$^\ddagger$\\ 
      ...
      &
      \includegraphics[width=0.5\textwidth]{tables_and_figures/pindex-whisker-9}
          \end{tabular}
  \end{minipage}   
    \begin{flushleft}
      \footnotesize
