\documentclass[3p, longtitle]{elsarticle}
%\pdfoutput=1
\usepackage{amsmath}
...
%\title[Causal Impact of Masks, Policies, Behavior]{Causal Impact of Masks, Policies, Behavior on Early Covid-19 Pandemic in the U.S.}
\title{Causal Impact of Masks, Policies, Behavior on Early Covid-19
  Pandemic in the U.S.}

%% Formatting instructions move this to the end
% \thanks{We are grateful to Daron Acemoglu, V.V. Chari, Raj Chetty,  Christian Hansen, Glenn Ellison, Ivan Fernandez-Val, David Green,  Ido Rosen, Konstantin Sonin, James Stock, Elie Tamer, and Ivan Werning for helpful comments. We also thank Chiyoung Ahn,
...
% which considerably improved the paper. All mistakes are our own. }


\author{Victor Chernozhukov\corref{ }}
\ead{vchern@mit.edu}
%\urladdr{www.mit.edu/$\sim$vchern} % Delete if not wanted.
\address{Department of Economics and Center for Statistics and Data
  Science, MIT,  MA 02139}

\author{Hiroyuki Kasahara\corref{cor1}}
\ead{hkasahar@mail.ubc.ca}
\address{Vancouver School of Economics, UBC, 6000 Iona Drive, Vancouver, BC.}

\author{Paul Schrimpf\corref{ }}
\ead{schrimpf@mail.ubc.ca}
\address{Vancouver School of Economics, UBC, 6000 Iona Drive, Vancouver, BC.}
...
\begin{keyword}
  Covid-19, causal impact, masks, policies, behavior
\end{keyword}
...
\footnote{All code is available at \url{https://github.com/ubcecon/covid-impact}.}Our baseline measures for daily Covid-19  cases and deaths are from
...
insightful comments, which considerably improved the paper. All
